<header class="flex z-50 sticky top-0 flex-wrap md:justify-start md:flex-nowrap w-auto border rounded-lg text-md py-3 md:py-0" style="background: rgba(230, 230, 230, 0.7); backdrop-filter: blur(10px);">
  <nav class="w-full mx-auto px-5 md:px-6 lg:px-8" aria-label="Global">
    <div class="relative md:flex md:items-center md:justify-between">
      <div class="flex items-center justify-between">
        <a class="text-blue flex-none text-xl font-semibold" id="brand" href="/" aria-label="Brand">Tomss14</a>
        <div class="md:hidden">
          <button type="button" class="hs-collapse-toggle flex justify-center items-center w-9 h-9 text-sm font-semibold rounded-lg border border-gray-200 text-gray-800 hover:bg-gray-100 disabled:opacity-50 disabled:pointer-events-none dark:text-secondary dark:border-gray-700 dark:hover:bg-gray-700 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600" data-hs-collapse="#navbar-collapse-with-animation" aria-controls="navbar-collapse-with-animation" aria-label="Toggle navigation">
        ...
        <div class="overflow-hidden overflow-y-auto max-h-[75vh] [&::-webkit-scrollbar]:w-2 [&::-webkit-scrollbar-thumb]:rounded-full [&::-webkit-scrollbar-track]:bg-gray-100 [&::-webkit-scrollbar-thumb]:bg-gray-300 dark:[&::-webkit-scrollbar-track]:bg-slate-700 dark:[&::-webkit-scrollbar-thumb]:bg-slate-500">
          <div class="flex flex-col gap-x-0 mt-5 divide-y divide-dashed divide-gray-200 md:flex-row md:items-center md:justify-end md:gap-x-7 md:mt-0 md:ps-7 md:divide-y-0 md:divide-solid dark:divide-gray-700">
            {{-- <div class="pt-3 md:pt-0">
              <input type="search" id="search-input" class="py-2 px-3 inline-flex items-center gap-x-2 font-mediums rounded-lg border border-transparent text-blue" placeholder="Search games...">
              <ul id="search-results" class="hidden absolute bg-white border rounded-lg p-2 w-full"></ul>
            </div> --}}

            <a class="font-medium text-blue py-3 md:py-6" href="/" aria-current="page">Home</a>

            <a class="font-medium text-blue py-3 md:py-6" href="/games">
              All Games
            </a>

            <a class="font-medium text-blue py-3 md:py-6" href="/games/popular-games">
              Popular Games
            </a>

            <div class="dropdown">
              <button class="dropbtn font-medium text-blue py-3 md:py-6">Games Platforms<i class="ms-2 bi bi-caret-down-fill"></i></button>
              <div class="dropdown-content border rounded-lg">
